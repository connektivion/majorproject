...
--
-- Table structure for table `mks19752012`
--

CREATE TABLE IF NOT EXISTS `mks19752012` (
  `station` tinytext,
...
--
-- Dumping data for table `mks19752012`
--

INSERT INTO `mks19752012` (`station`, `r75`, `r125`, `Rx1Day`, `Rx5Day`, `SD2`, `PRCPTOT`, `CWD`, `CDD`, `R95pTOT`, `R99pTOT`) VALUES
